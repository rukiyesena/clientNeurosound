	...
	var _handleFormSignin = function() {
		...
		FormValidation
			...
			.on('core.form.invalid', function() {
				Swal.fire({
					text: "Üzgünüz, görünüşe göre bir hata tespit edildi, lütfen tekrar deneyin.",
					icon: "error",
					buttonsStyling: false,
		            ...
		            fields: {
						email: {
							validators: {
								...
								emailAddress: {
									message: 'Bu geçerli bir e-mail adresi değil!'
								}
							}
						}
		            },
			...
			form,
			{
				fields: {
					...
					lname: {
						validators: {
							notEmpty: {
								message: 'Kullanıcı Soyadı gerekli!'
							}
						}
					},
					phone: {
