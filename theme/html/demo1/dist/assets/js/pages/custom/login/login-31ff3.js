...
var KTLogin = function() {
	...
	var _handleFormSignin = function() {
		...
		FormValidation
			...
			.on('core.form.invalid', function() {
				Swal.fire({
					text: "Üzgünüz, bir hata tespit edildi gibi duruyor, lütfen tekrar deneyin.",
					icon: "error",
					buttonsStyling: false,
		            ...
		            fields: {
						email: {
							validators: {
								...
								emailAddress: {
									message: 'Bu değer doğru bir mail adresi değil.'
								}
							}
						}
		            },
	...
	var _handleFormSignup = function() {
		...
		wizardObj.on('submit', function (wizard) {
			Swal.fire({
				text: "Hepsi tamam! Lütfen form göndermeyi onaylayın.",
				icon: "success",
