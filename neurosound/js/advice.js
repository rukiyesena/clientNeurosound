    ...
    $.ajax({
        ...
        .then(function () {
            ...
            $("#save").click(function () {
                ...
                if (urlTest == null) {
                    $.ajax({
                        url: "http://localhost:8080/advice/tests/" + itemkey + "/add",
                        type: "POST",
                        data: obj,
                        xhrFields: {
    ...
    $.ajax({
        ...
        .then(function () {
            ...
            var table = $('#kt_datatable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        "data": function (deger) {
                            html = '\
                            <a href="advice.html?id={0}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Tavsiye Düzenle"> \
                                <span class="svg-icon svg-icon-md">\
            ...
            $('#exampleModalSizeSm').on('click', '#deleteButton', function () {
                $.ajax({
                    url: "http://localhost:8080/advice/delete",
                    method: "DELETE",
                    data: variable,
                })
                    .done(function (data, textStatus, jqXHR) {
